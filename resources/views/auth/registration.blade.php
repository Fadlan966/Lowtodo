        ...
        <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" placeholder="John Doe"
                        class="w-full pl-10 p-3 border border-gray-700 rounded-lg bg-theme-input text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 @error('name') border-red-500 @enderror"
                        required>
                </div>
                @error('name')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="••••••••••"
                        class="w-full pl-10 p-3 border border-gray-700 rounded-lg bg-theme-input text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 @error('password_confirmation') border-red-500 @enderror"
                        required>
                    <button type="button" onclick="togglePassword('password_confirmation', 'password-confirmation-icon')" class="absolute right-3 top-3 text-gray-400 hover:text-gray-200 transition">
                        <svg id="password-confirmation-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51
                                7.36 4.5 12 4.5c4.638 0 8.573 3.007
                                9.963 7.178.07.207.07.431 0
            ...
            <div class="flex items-start mt-4">
                <div class="flex items-center h-5">
                    <input id="terms" name="terms" type="checkbox" class="accent-blue-500 w-4 h-4" required>
                </div>
                <div class="ml-3 text-sm">
                    <label for="terms" class="text-gray-300">I agree to the <a href="#" class="text-blue-400 hover:text-blue-300">Terms of Service</a> and <a href="#" class="text-blue-400 hover:text-blue-300">Privacy Policy</a></label>
                </div>
            </div>

            <!-- Button Register -->
            <button type="submit"
                class="w-full bg-theme-accent text-white py-3 rounded-lg hover:bg-blue-500 transition duration-200 font-medium flex justify-center items-center mt-6">
