    <div id="modalCreateCard" class="fixed inset-0 flex items-center justify-center p-4 z-50 hidden">
        <div class="bg-gray-800 rounded-lg shadow-lg w-full max-w-md relative z-50">
            ...
            <div class="flex justify-between items-center p-4 border-b">
                <h2 class="text-xl font-semibold text-white">Create New Card</h2>
                ...
                <form id="createCardForm" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" id="card_title" name="title" required
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-white bg-gray-700">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="card_description" name="description"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-white bg-gray-700"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <span id="card-file-name" class="text-sm text-white"></span>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="flex justify-end p-4 border-t">
                <button id="submitCreateCard" type="button"
                    class="px-4 py-2 bg-white text-black rounded-md hover:bg-blue-500 hover:text-white cursor-pointer transition-colors">
                    Create Card
                </button>
            </div>
        </div>
