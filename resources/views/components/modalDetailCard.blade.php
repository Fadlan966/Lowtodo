<div id="modalDetailCard" class="fixed inset-0 flex items-center justify-center p-4 z-50 hidden">
    <div class="bg-gray-800 rounded-lg shadow-lg w-full max-w-md relative z-50">
        ...
        <div class="flex justify-between items-center p-4 border-b">
            <h2 class="text-xl font-semibold text-white">Card Details</h2>
        ...
        <div class="modal-content p-4 space-y-4 overflow-y-auto max-h-[80vh] text-white">
            <form id="updateCardForm" enctype="multipart/form-data">
                ...
                <div class="flex items-center">
                    ...
                    <label for="card_is_due_checked" class="ml-2 block text-sm text-white">
                        Mark as completed
                    </label>
                </div>
                ...
                <!-- Image Upload -->
                <div>
                    <label class="block text-sm font-medium text-gray-800">Change Image</label>
                    <input type="file" id="card_image" name="img" accept="img/*"
